...
public class CustomLineElement extends HText {
    ...
    protected void drawFrame(Canvas canvas) {
        ...
        xLineLength = (int) (mHTextView.getWidth() - (mHTextView.getWidth() - distWidth + gap) *
                percent);
        yLineLength = (int) (mHTextView.getHeight() - (mHTextView.getHeight() - distHeight + gap)
                * percent);
        ...
        p3.x = mHTextView.getWidth() - (mHTextView.getWidth() / 2 + distWidth / 2 - gap +
                xLineWidth / 2) * percent;
        ...
        p4.y = mHTextView.getHeight() - (mHTextView.getHeight() / 2 + distHeight / 2 + gap +
                xLineWidth / 2) * percent;
